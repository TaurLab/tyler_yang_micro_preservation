...
compared with the baseline sample, 1A. Taxa are ordered by relative
abundance in the baseline sample. Colored bars represent taxon
abundances in each comparison sample, with colors indicating taxonomic
classification. The black overlay line shows the baseline abundance
profile for the same ordered taxa. Blue labels indicate the
Morisita--Horn distance between each comparison sample and baseline.}
...
compared with the baseline sample, 2A. Taxa are ordered by relative
abundance in the baseline sample. Colored bars represent taxon
abundances in each comparison sample, with colors indicating taxonomic
classification. The black overlay line shows the baseline abundance
profile for the same ordered taxa. Blue labels indicate the
